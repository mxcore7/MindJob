...
<template>
  <div class="min-h-screen flex items-center justify-center relative overflow-hidden bg-dark">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div class="absolute -top-40 -right-40 w-[500px] h-[500px] rounded-full bg-secondary/10 blur-[120px] animate-pulse"></div>
      <div class="absolute -bottom-40 -left-40 w-[500px] h-[500px] rounded-full bg-primary/10 blur-[120px] animate-pulse" style="animation-delay: 1.5s;"></div>
    </div>
    ...
    <div class="max-w-md w-full mx-4 relative z-10 animate-fade-in-up">
      ...
      <div class="text-center mb-10">
        <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-secondary to-primary mb-4 glow">
          <svg class="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
          </svg>
        </div>
        <h1 class="text-3xl font-bold text-gradient">Job Intelligent</h1>
        <p class="text-slate-400 mt-2 text-sm">Start your intelligent career journey</p>
      </div>

      <div class="glass rounded-2xl p-8 glow-sm">
        <h2 class="text-xl font-bold text-white mb-1">Create account</h2>
        <p class="text-slate-400 text-sm mb-6">Join thousands of professionals</p>
        ...
        <form @submit.prevent="submitRegister" class="space-y-5">
          <div>
            ...
            <input id="full_name" type="text" required v-model="form.full_name" class="input-dark w-full px-4 py-3 rounded-xl text-sm" placeholder="John Doe">
          </div>
          <div>
          ...
          <div>
            ...
            <input id="password" type="password" required v-model="form.password" class="input-dark w-full px-4 py-3 rounded-xl text-sm" placeholder="Min. 8 characters">
          </div>
        ...
        <div class="mt-6 text-center">
          <RouterLink to="/login" class="text-sm text-secondary hover:text-secondary-dark transition-colors">
